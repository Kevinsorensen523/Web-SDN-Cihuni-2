                    ...
                    <div class="card border-dark">
                        <div class="card-body">
                            <div class="text-end">
                                ...
                                <a href="/kegiatan/{{$kegiatan->id}}/edit" style="text-decoration: none; color: black;">Edit</a> |
                                <a href="/addPhoto/kegiatan/{{$kegiatan->id}}" style="text-decoration: none; color: black;">Add Foto</a> |
                                <a href="/kegiatan/deletePhoto/{{$kegiatan->id}}" style="text-decoration: none; color: black;">Delete Foto</a> 
                            </div>
                            <h1 class="card-title">
                                {{$kegiatan->judul}}
                            </h1>
