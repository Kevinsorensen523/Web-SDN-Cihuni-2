                        ...
                        <div class="card-body" style="color: #171136;">
                            <form action="simpan-siswa.php" method="POST">    
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul" placeholder="Masukkan Nama Kegiatan" value="{{$ekskul->judul}}" class="form-control">
                                </div> <br />
                                <div class="form-group">
                                    <label>Keterangan Ekstrakulikuler</label>
                                    <textarea class="form-control" name="deskripsi" placeholder="Masukkan Keterangan Kegiatan" value="{{$ekskul->deskripsi}}" rows="4"></textarea>
                                </div> <br />
                                <div class="custom-file">
                                    <label class="custom-file-label" for="inputGroupFile01">THUMBNAIL</label> <br />
                                    @foreach($photos as $foto)
                                    @if($foto->path == $ekskul->thumbnail)
