...
<html>
    ...
    <body style="background-image: url('https://img.freepik.com/free-vector/topographic-contour-lines-map-seamless-pattern_1284-52862.jpg?w=740&t=st=1670415796~exp=1670416396~hmac=943e99f8c8791b8dca671c192b27369116d45fbf9defbd872b617646fd9fa472');">
        <div class="container">
        <form action="/ekskul" method="post" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card" style="box-shadow: 0 0 10px;">
                        ...
                        <div class="card-body" style="color: #171136;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul" placeholder="Masukkan Nama Kegiatan" class="form-control">
                            </div> <br />

                            <div class="form-group">
                                <label>Keterangan Ekskul</label>
                                <textarea class="form-control" name="deskripsi" placeholder="Masukkan Keterangan Kegiatan" rows="4"></textarea>
                            </div> <br />
                            
                            <div class="custom-file">
                                <label class="custom-file-label" for="inputGroupFile01">Foto Ekskul</label> <br />
