                    ...
                    <div class="card" style="box-shadow: 0 0 10px;">
                        ...
                        <div class="card-body" style="color: #171136;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" placeholder="Masukkan Nama Kegiatan" class="form-control">
                            </div> <br />

                            <div class="form-group">
                                <label>Jabatan</label>
                                <input type="text" name="job" placeholder="Masukkan Jabatan Staff" class="form-control">
                            </div> <br />
                            
                            <div class="custom-file">
                                <label class="custom-file-label" for="inputGroupFile01">Foto Staff</label> <br />
